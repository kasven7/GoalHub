...
export default function StandingsAndFixtures({
    ...
    return(
    <div className="flex flex-col w-full max-w-7xl rounded-3xl bg-gradient-to-br from-green-500/75 to-green-500/20 lg:flex-row">
        <div className="flex justify-center items-center lg:w-2/4 md:p-10 py-5">
            <div className="flex flex-col justify-center items-center bg-neutral-800 w-full text-neutral-100 rounded-3xl">
                <div className="w-full flex flex-col justify-center items-center">
                    ...
                    <div className="flex justify-center w-full">
                        {
                            menuItems.map((a,i) =>(
                                <button
                                    key = {i}
                                    className={`w-full p-4 rounded-t-lg md:text-base text-xs font-bold ${i=== activeTab ? 'text-neutral-100':'text-gray-700 bg-black/70'}`}
                    ...
                    <div 
                        ref={menuRef}
                        className="w-full flex overflow-x-hidden snap-x scrollbar-none scroll-smooth text-xs md:test-sm"
                    >
                            {
                                            ...
                                            </div>
                                            {
                                                responseData.league.standings[0].map((team,j)=>(
                                                    <Link
                                                        ...
                                                        className = {`flex w-full p-1 hover:bg-blue-600/50
                                                        ${j % 2 ===0 ? 'bg-black/40': ''}`}
                                                    >
        ...
        <div className="flex justify-center items-center lg:w-2/4 pt-10 lg:pr-10 pb-10 lg:pl-0">
